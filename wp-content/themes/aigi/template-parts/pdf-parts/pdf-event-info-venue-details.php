...
if (!empty(get_field('venue_details', $post))) {
    ...
    if ($venue_details['catered'] == 'yes' || !empty($venue_details['accessibility_options']) || !empty($venue_details['carparking_options']) || !empty($venue_details['other_transport_options']) || !empty($venue_details['covid_safe_plan'])) { ?>
        ...
        <?php if (!empty($venue_details["accessibility_options"])) { ?>
        ...
        <?php if (!empty($venue_details['carparking_options'])) { ?>
            <div class="post-details__item" style="padding: 8px 0 8px 12px;">
        ...
        <?php if (!empty($venue_details['other_transport_options'])) { ?>
            <div class="post-details__item" style="padding: 8px 0 8px 12px;">
        ...
        <?php if (!empty($venue_details['covid_safe_plan'])) { ?>
            <div class="post-details__item" style="padding: 8px 0 8px 12px;">
