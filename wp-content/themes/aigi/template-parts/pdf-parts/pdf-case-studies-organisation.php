...
if (!empty(get_field('organization',$post))) {
...
if (!empty($organization)) { ?>
    <div class="post-details__item organisation-info" style="font-size: 14px;line-height: 22px;letter-spacing: 0.08em;margin-bottom: 32px;">
        ...
        <?php if (!empty($organization['about'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
        ...
        <?php if (!empty($organization['purpose'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
        ...
        <?php if (!empty($organization['locations'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
        ...
        <?php if (!empty($organization['incorporated'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
        ...
        <?php if (!empty($organization['governance_features'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
        ...
        <?php if (!empty($organization['achievements'])) : ?>
        ...
        <?php if (!empty($organization['this_profile_last_updated'])) { ?>
        <div class="post-details__text inline" style="margin-bottom: 16px;display: inline">
