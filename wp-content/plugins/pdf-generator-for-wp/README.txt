...
**3.** Allow direct download of pdf files or send them to users’ email addresses. 
**4.** Get a Shortcode to add the PDF icon anywhere on the page.
**5.** Get a shortcode to insert your own pdf.
**6.** Set the PDF download button’s location. 
**7.** Set a custom PDF download icon.
**8.** Predefined header, footer, and body settings.
...
We have already provided the shortcode. You can use that shortcode to place the PDF button on a particular product page.
