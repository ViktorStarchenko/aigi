...
function relevanssi_update_premium_options() {
	...
	relevanssi_update_off_or_on( $request, 'relevanssi_index_post_type_archives', false );
	relevanssi_update_off_or_on( $request, 'relevanssi_index_subscribers', false );
	relevanssi_update_off_or_on( $request, 'relevanssi_index_synonyms', false );
	relevanssi_update_off_or_on( $request, 'relevanssi_index_taxonomies', false );
	relevanssi_update_off_or_on( $request, 'relevanssi_index_users', false );
	...
	relevanssi_update_sanitized( $request, 'relevanssi_api_key', false );
